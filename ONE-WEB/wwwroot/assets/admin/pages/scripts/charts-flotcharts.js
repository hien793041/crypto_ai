var ChartsFlotcharts = function() {
    ...
    return {
        ...
        initCharts: function() {
            ...
            function chart_Markets() {
                if ($('#chart_Markets').size() != 1) {
                    return;
                }
                var d1 = [];
                ...
                var d4 = [];
                for (var i = 0; i <= 10; i += 1)
                    d4.push([i,  parseInt(Math.random() * 30) + 1]);
                    ...
                    $.plot($("#chart_Markets"),
                        ...
                        , {
                            series: {
                                ...
                                //colors: ["#ff0017", "#848e9c", "#1aa67c", "#fdff12"]
                            },
                            grid: {
                                tickColor: "#eee",
                                borderColor: "#eee",
                            ...
                            colors: ["#ff0017", "#00D919", "#1aa67c", "#fdff12"],
                            yAxes: [{ stacked: true }]
                        }
                    );
                }

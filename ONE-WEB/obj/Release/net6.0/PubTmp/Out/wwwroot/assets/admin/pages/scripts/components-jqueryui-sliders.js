...
var ComponentsjQueryUISliders = function () {
    ...
    return {
        ...
        init: function () {
            ...
            //        angular.element(document.getElementById('kt_content')).scope().TradingDateActive =
            //            angular.element(document.getElementById('kt_content')).scope().TradingDates[ui.value - 1].TradingDate;
